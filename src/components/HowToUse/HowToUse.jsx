  ...
  return (
    <>
      <ContentContainer>
        ...
        <TopHeading>
          Ready to eliminate jet lag and boost your energy level on future trips?
        </TopHeading>
        <Review>
          <ReviewerImage>
            <img
      ...
      <MobileImageFlex style={{}}>
        <ImageCardFlex1>
          <img src={""} alt="Image" />
        </ImageCardFlex1>
        <ContentCardFlex1>
          "Don't worry We will tell you exactly what to do and when to do it."
        </ContentCardFlex1>
      </MobileImageFlex>
      <ThreeIconsContainer>
        <WbSunnyIcon />
      ...
      <TextBox
        style={{ textAlign: "center", padding: "30px", marginBottom: "20px" }}
      >
        You don't have to do everything perfectly, but the more you do, the less
        jet lag you will experiance.
      </TextBox>
      <MobileImageFlex>
        <ContentCardFlex1>
