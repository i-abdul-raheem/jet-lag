  ...
  return (
    <div>
      <PageContainer>
        ...
        <TopHeading>
          <StyledText style={{ fontSize: "25px" }}>Singapore</StyledText>
        </TopHeading>
      </PageContainer>
      <CalendarContainer>
        <EachTableBox>
          <OverlayBox>
            <OverlayContainer>
              <OverlayColumns topL={1} leftL={0} heightL={6}>
          ...
          <EachTable>
            <TableHead>
              <TableRow>
                <TableHeading>May 6</TableHeading>
        ...
        <EachTableBox>
          ...
          <EachTable>
            <TableHead>
              <TableRow>
                <TableHeading>May 7</TableHeading>
                <TableHeading colSpan={2} style={{ textAlign: "right" }}>
                  Singapore 15:00
                </TableHeading>
              </TableRow>
